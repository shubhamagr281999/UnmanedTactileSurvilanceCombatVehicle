...
rotation_per_cycle=Lstance/(0.3+b); %if bot is roating then it would rotate by this much degree in each cycle
...
for i=0:1:number_of_rotation_point
    ...
    q0=trajec_real(1+rem(S(1)*10+i,points_per_Cycle),:);
    q1=trajec_real(1+rem(S(2)*10+i,points_per_Cycle),:);
    q2=trajec_real(1+rem(S(3)*10+i,points_per_Cycle),:);
    q3=trajec_real(points_per_Cycle-rem(S(4)*10+i,points_per_Cycle),:);
    q4=trajec_real(points_per_Cycle-rem(S(5)*10+i,points_per_Cycle),:);
    q5=trajec_real(points_per_Cycle-rem(S(6)*10+i,points_per_Cycle),:);
    ...
    hold on
    patch(base_points(1,:),base_points(2,:),base_points(3,:),'db', 'facealpha',0.7)
    grid on
    xlabel('x')
    ylabel('y')
    zlabel('z')
    ...
    plot3(l1_0(1,:),l1_0(2,:),l1_0(3,:),'LineWidth',4,'Color','k')
    plot3(l1_1(1,:),l1_1(2,:),l1_1(3,:),'LineWidth',4,'Color','k')
    plot3(l1_2(1,:),l1_2(2,:),l1_2(3,:),'LineWidth',4,'Color','k')
    plot3(l1_3(1,:),l1_3(2,:),l1_3(3,:),'LineWidth',4,'Color','k')
    plot3(l1_4(1,:),l1_4(2,:),l1_4(3,:),'LineWidth',4,'Color','k')
    plot3(l1_5(1,:),l1_5(2,:),l1_5(3,:),'LineWidth',4,'Color','k')
    ...
    l2_4=[b4 c4];
    l2_5=[b5 c5];
    plot3(l2_0(1,:),l2_0(2,:),l2_0(3,:),'LineWidth',4,'Color','r')
    plot3(l2_1(1,:),l2_1(2,:),l2_1(3,:),'LineWidth',4,'Color','r')
    plot3(l2_2(1,:),l2_2(2,:),l2_2(3,:),'LineWidth',4,'Color','r')
    plot3(l2_3(1,:),l2_3(2,:),l2_3(3,:),'LineWidth',4,'Color','r')
    plot3(l2_4(1,:),l2_4(2,:),l2_4(3,:),'LineWidth',4,'Color','r')
    plot3(l2_5(1,:),l2_5(2,:),l2_5(3,:),'LineWidth',4,'Color','r')
    ...
    l3_4=[c4 d4];
    l3_5=[c5 d5];
    plot3(l3_0(1,:),l3_0(2,:),l3_0(3,:),'LineWidth',4,'Color','g')
    plot3(l3_1(1,:),l3_1(2,:),l3_1(3,:),'LineWidth',4,'Color','g')
    plot3(l3_2(1,:),l3_2(2,:),l3_2(3,:),'LineWidth',4,'Color','g')
    plot3(l3_3(1,:),l3_3(2,:),l3_3(3,:),'LineWidth',4,'Color','g')
    plot3(l3_4(1,:),l3_4(2,:),l3_4(3,:),'LineWidth',4,'Color','g')
    plot3(l3_5(1,:),l3_5(2,:),l3_5(3,:),'LineWidth',4,'Color','g')
