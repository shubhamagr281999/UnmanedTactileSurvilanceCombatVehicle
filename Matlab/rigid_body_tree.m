...
for i=0:1:200
    ...
    q0=trajec_real(rem(0*10+i,60)+1,:);
    q1=trajec_real(rem(1*10+i,60)+1,:);
    q2=trajec_real(rem(2*10+i,60)+1,:);
    q3=trajec_real(rem(3*10+i,60)+1,:);
    q4=trajec_real(rem(4*10+i,60)+1,:);
    q5=trajec_real(rem(5*10+i,60)+1,:);
